    ...
    <body>
        <div class="header-container">
            ...
            <div class="cart_container">
                ...
                <!--=================================================CONG GIO HANG=========================================-->
                <p style="margin-left: 700px;margin-top: 20px; color:black; font-size: 17px;">Tạm tính: <?php echo sum($result1)." đ";?></p>
                <p  style="margin-left: 700px;margin-top: 20px; color:black; font-size: 17px;">Phí giao hàng: <?php echo (sum($result1)*0.01)." đ";?></p>
                <h3  style="margin-left: 700px;margin-top: 20px; color:black; font-size: 17px;">Tổng: <?php echo (sum($result1)+(sum($result1)*0.01))." đ";?></h3>
                <hr/>
